...
export async function loadSocialSecurityData(
  supabase: SupabaseClient,
  userId: string,
): Promise<SocialSecurityData | null> {
  ...
  const p1Name =
    household.person1_first_name ?? displayPersonFirstName(household.person1_name, 'Person 1')
  ...
  const p2Name =
    household.person2_first_name ?? displayPersonFirstName(household.person2_name, 'Person 2')
  ...
  let p2Data: SocialSecurityData['person2'] = null
  if (hasSpouse) {
