...
const HEADER_SCORE_ALIASES = new Set([
  ...
  'symbol', 'ticker', 'cusip', 'quantity', 'shares', 'units', 'qty',
  'lastprice', 'last', 'closeprice', 'costbasis', 'cost', 'gainloss',
  'accountdescription', 'accountnumber', 'positionname', 'securitydescription',
