...
# Last updated: 2026-05-27 (Sprint F profile gates + Sprint E form refresh; Sprint 17 go-live prep)
...
| 2026-05-27 | Post-launch perf Sprint I | **Closed** — `error.tsx` + `RouteErrorFallback` on hot prefetch routes. |
