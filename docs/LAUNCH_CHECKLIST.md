...
- [ ] **Post-deploy Voels verify** — `npm run verify:post-deploy-voels` after prod deploy; daily cron `/api/cron/post-deploy-verify` (9:00 UTC) alerts via Vercel logs on failure.
