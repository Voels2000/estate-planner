...
# Last updated: May 2026 (Sprint 14 — §1–7 passed; 2 bugs block Section 1 sign-off)
...
**Sprint 14 manual smoke (2026-05-23):** Core §1–3 and estate §4–7 **passed** on staging. **Blocks Section 1 full sign-off:** Admin Portal link visible to consumer; asset add form save button below viewport. See CONSUMER_RELEASE_SMOKE_TEST.md sign-off block.
...
| Optional smoke §8–11 | Not run | Sprint 14 remainder |
| Drip steps 2–3 | Not verified | Sprint 14 remainder |
| Section 1 full sign-off | Pending 2 bug fixes | After sidebar + asset form |
...
| May 2026 | Sprint 14 | `93aa6f5` core-recompute E2E; `1e092d7` manual §1–7 passed; 2 bugs open before Section 1 sign-off |
