...
- As of **2026-06-07**, titling list perf: **`buildTitlingLookups`** + memoized **`getTitlingWarnings`** (`lib/titling/`); memoized **`AssetTitlingCard`**; **`household_people`** fetched in parallel on `page.tsx`. Modal code-split and table virtualization deferred.
