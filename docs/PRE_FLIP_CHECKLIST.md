...
- ✅ **Profiles advisor SELECT status gate** — `20260726120000` applied staging + prod (2026-06-26); post-revoke PostgREST profile leak closed; regression `advisor-profiles-revocation-rls.spec.ts` (RED pre-migration, GREEN after). [#150](https://github.com/Voels2000/estate-planner/pull/150)
