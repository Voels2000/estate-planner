...
**Migration:** `20260726130000_profiles_advisor_select_status_gate.sql`
...
**Apply staging:** `bash scripts/apply-migration.sh staging supabase/migrations/20260726130000_profiles_advisor_select_status_gate.sql` — applied 2026-06-26.

**Apply production:** same path with `production` — applied 2026-06-26; ledger row `20260726130000` (version `20260726120000` is reserved for `one_time_purchases_refund_ack`).
...
- **Manual remaining:** [LAUNCH.md](./LAUNCH.md) — 3 TODO placeholders; counsel sign-off; email aliases
...
- **Sprint 17 remaining (non-code):** [LAUNCH.md](./LAUNCH.md); Stripe Dashboard + C-4 walkthrough; counsel sign-off; go-live day Supabase Auth + `PUBLIC_SIGNUP_OPEN=true` + Core §1–3 smoke
