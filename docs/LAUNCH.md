...
- [ ] **Track 2 — advisor↔consumer prod canary:** follow [prod-smoke-canary-runbook.md](./prod-smoke-canary-runbook.md) (link pair, manual isolation, retire `PROD_SMOKE_EXCLUDE`)
