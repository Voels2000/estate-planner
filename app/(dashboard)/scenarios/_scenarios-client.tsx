...
export type ScenariosHousehold = Household
...
export default function ScenariosClient({
  ...
  async function fetchScenario(
    ...
    try {
      ...
      if (data.rows) setter(summarizeScenario(data.rows, overrides.person1_retirement_age))
    } catch {
  ...
  useEffect(() => {
    ...
    const base: ScenarioOverrides = {
      ...
      person1_ss_claiming_age: initialHousehold.person1_ss_claiming_age ?? 67,
      person2_retirement_age:  initialHousehold.person2_retirement_age ?? null,
      person2_ss_claiming_age: initialHousehold.person2_ss_claiming_age ?? null,
