...
export function AddIncomeModal({ open, onClose, onSuccess, ownerId }: Props) {
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-4 space-y-4">
        ...
        <div className="space-y-1.5">
          <label htmlFor="income-start-year" className={labelClass}>
            Start year
          </label>
          <input
        ...
        <div className="space-y-1.5">
          <label htmlFor="income-end-year" className={labelClass}>
            End year (optional)
          </label>
          <input
            id="income-end-year"
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <label
            htmlFor="income-inflation-adjust"
