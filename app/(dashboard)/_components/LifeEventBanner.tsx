...
export function LifeEventBanner({ pendingEvents, hasAdvisorConnection = false }: Props) {
  ...
  if (submitted) {
    ...
    return (
      <div className="mt-4 mb-2 rounded-xl border border-green-200 bg-green-50 px-4 py-3 space-y-2">
          ...
          <div className="flex items-start gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-xs text-green-700">
                Your plan will reflect this event.
              </p>
        ...
        {!hasAdvisorConnection && (
          <div className="ml-7 rounded-lg border border-green-200 bg-white px-3 py-2.5 flex items-center justify-between gap-3 flex-wrap">
            <p className="text-xs text-neutral-600">
              <span className="font-medium text-neutral-800">No advisor connected yet.</span>
              {' '}An advisor can help you navigate {label.toLowerCase()} — especially at your asset level.
            </p>
            <a
              href="/find-advisor"
              className="shrink-0 text-xs font-semibold text-indigo-600 underline-offset-2 hover:underline whitespace-nowrap"
            >
              Find one →
            </a>
          </div>
