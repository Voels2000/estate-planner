            ...
            <div style="background:#f9fafb;border-radius:8px;padding:32px;margin:24px 0">
              ...
              <table style="width:100%;border-collapse:collapse;margin:16px 0">
                <tr>
                  ...
                  <td style="padding:8px 0;color:#111827;font-size:14px;font-weight:600">${firm_name}</td>
                </tr>
                <tr>
                  <td style="padding:8px 0;color:#6b7280;font-size:14px">Contact</td>
                  <td style="padding:8px 0;color:#111827;font-size:14px">${contact_name ?? '—'}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="padding:8px 0;color:#111827;font-size:14px">${[city, state].filter(Boolean).join(', ') || '—'}</td>
                </tr>
              </table>
