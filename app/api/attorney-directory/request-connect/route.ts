...
export async function POST(request: Request) {
  ...
  if (existing) {
    return NextResponse.json(
      { error: 'You already have a pending request with this attorney' },
      { status: 409 }
    )
  }
    ...
    try {
          ...
          <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:40px 20px">
            ...
            <div style="background:#f9fafb;border-radius:8px;padding:32px;margin:24px 0">
              ...
              <p style="color:#6b7280;font-size:14px;text-align:center">
                Click above to log in or create your attorney account and respond to this request.
              </p>
            </div>
      ...
      if (listing.profile_id) {
        await admin.rpc('create_notification', {
          ...
          p_body: `${consumerLabel} has requested to connect with you. Check your attorney portal to respond.`,
          p_delivery: 'in_app',
