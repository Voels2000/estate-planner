...
export async function POST(request: Request) {
  try {
    ...
    const { error: emailError } = await resend.emails.send({
      ...
      to: invitedEmail,
      subject: `${advisor.full_name} has invited you to My Wealth Maps`,
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:40px 20px">
          ...
          <div style="background:#f9fafb;border-radius:8px;padding:32px;margin:24px 0">
            ...
            <p style="color:#374151;font-size:16px;line-height:1.6"><strong>${advisor.full_name}</strong> has invited you to join My Wealth Maps.</p>
