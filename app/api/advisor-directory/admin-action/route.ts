...
export async function POST(req: NextRequest) {
  try {
    ...
    replyTo: EMAIL_REPLY_TO,
            ...
            subject: 'Your advisor listing is now live — My Wealth Maps',
            html: `
              <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:40px 20px">
                ...
                <div style="background:#f9fafb;border-radius:8px;padding:32px;margin:24px 0">
                  ...
                  <p style="color:#374151;font-size:16px;line-height:1.6">
                    ...
                    in the My Wealth Maps advisor directory. Consumers can find your listing
    ...
    replyTo: EMAIL_REPLY_TO,
            to: listing.email,
            bcc: 'avoels@comcast.net',
            subject: 'Your advisor listing was not approved — My Wealth Maps',
            html: `
              <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:40px 20px">
                <h1 style="color:#1a1a2e;font-size:24px">My Wealth Maps</h1>
                <div style="background:#f9fafb;border-radius:8px;padding:32px;margin:24px 0">
                  <p style="color:#374151;font-size:16px;line-height:1.6">Hi ${listing.contact_name ?? 'there'},</p>
                  <p style="color:#374151;font-size:16px;line-height:1.6">
                    Thank you for your interest in joining the My Wealth Maps advisor directory.
