CREATE OR REPLACE FUNCTION public.calculate_estate_composition(p_household_id uuid, p_source_role text DEFAULT 'consumer'::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
