-- Restore adjusted_taxable_gifts (IRC §2001(b)) add-back in calculate_estate_composition.
-- Re-enables ATG intake wired via adjusted_taxable_gifts table.
...
BEGIN
  ...
  -- Adjusted taxable gifts (IRC §2001(b) — post-1976 taxable gifts add-back)
